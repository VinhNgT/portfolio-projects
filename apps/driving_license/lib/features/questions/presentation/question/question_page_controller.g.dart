...
String _$questionPageControllerHash() =>
    r'090aaaef37862414db296680edca8127bfc97974';
...
abstract class _$QuestionPageController
...
const questionPageControllerProvider = QuestionPageControllerFamily();

/// See also [QuestionPageController].
class QuestionPageControllerFamily extends Family<void> {
  /// See also [QuestionPageController].
  const QuestionPageControllerFamily();

  /// See also [QuestionPageController].
  QuestionPageControllerProvider call(
    Question question,
  ) {
    return QuestionPageControllerProvider(
      question,
    );
  }

  @override
  QuestionPageControllerProvider getProviderOverride(
    covariant QuestionPageControllerProvider provider,
  ) {
    return call(
      provider.question,
    );
  ...
  @override
  String? get name => r'questionPageControllerProvider';
}

/// See also [QuestionPageController].
class QuestionPageControllerProvider
    extends AutoDisposeNotifierProviderImpl<QuestionPageController, void> {
  /// See also [QuestionPageController].
  QuestionPageControllerProvider(
    Question question,
  ) : this._internal(
          () => QuestionPageController()..question = question,
          from: questionPageControllerProvider,
          name: r'questionPageControllerProvider',
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$questionPageControllerHash,
          dependencies: QuestionPageControllerFamily._dependencies,
          allTransitiveDependencies:
              QuestionPageControllerFamily._allTransitiveDependencies,
          question: question,
        );

  QuestionPageControllerProvider._internal(
  ...
  void runNotifierBuild(
    covariant QuestionPageController notifier,
  ) {
  ...
  @override
  Override overrideWith(QuestionPageController Function() create) {
    return ProviderOverride(
      origin: this,
      override: QuestionPageControllerProvider._internal(
  ...
  @override
  AutoDisposeNotifierProviderElement<QuestionPageController, void>
      createElement() {
    return _QuestionPageControllerProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is QuestionPageControllerProvider &&
...
mixin QuestionPageControllerRef on AutoDisposeNotifierProviderRef<void> {
  /// The parameter `question` of this provider.
  Question get question;
}

class _QuestionPageControllerProviderElement
    extends AutoDisposeNotifierProviderElement<QuestionPageController, void>
    with QuestionPageControllerRef {
  _QuestionPageControllerProviderElement(super.provider);

  @override
  Question get question => (origin as QuestionPageControllerProvider).question;
}
